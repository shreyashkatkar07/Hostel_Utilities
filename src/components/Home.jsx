...
const Home = () => {
  ...
  const handleShadow1=()=>
  {
    setShadow1("rgba(255, 255, 255, 0.29) 0px 4px 8px 0px, rgb(255, 255, 255) 0px 6px 20px 0px");
  }
  ...
  const handleShadow2=()=>
  {
    setShadow2("rgba(255, 255, 255, 0.29) 0px 4px 8px 0px, rgb(255, 255, 255) 0px 6px 20px 0px");
  }
  ...
  const handleShadow3=()=>
  {
    setShadow3("rgba(255, 255, 255, 0.29) 0px 4px 8px 0px, rgb(255, 255, 255) 0px 6px 20px 0px");
  }
  ...
  const handleShadow4=()=>
  {
    setShadow4("rgba(255, 255, 255, 0.29) 0px 4px 8px 0px, rgb(255, 255, 255) 0px 6px 20px 0px");
  }
        ...
        <div className="flex flex-wrap flex-row w-[100%] justify-center lg:justify-normal">
          <div className="h-[420px] p-10">
            <Link to="/filecomplaint">
              <div
                className="max-w-sm rounded-[40px] overflow-hidden shadow-lg h-[100%] bg-white text-gray-800 min-w-[300px] flex justify-between items-center flex-col" onMouseEnter={handleShadow1} onMouseLeave={handleNoShadow1}
                style={{
                  boxShadow:
                    `${shadow1}`,
                }}
          ...
          <div className="cards h-[420px] p-10">
            <Link to="/guestroombook">
              <div
                className=" max-w-sm rounded-[40px] overflow-hidden shadow-lg h-[100%] bg-white text-gray-800 min-w-[300px] flex justify-between items-center flex-col" onMouseEnter={handleShadow2} onMouseLeave={handleNoShadow2}
                style={{
                  boxShadow:
                  `${shadow2}`,
                }}
          ...
          <div className="cards h-[420px] p-10">
            <Link to="/applyforleave">
              <div
                className=" max-w-sm rounded-[40px] overflow-hidden shadow-lg h-[100%] bg-white text-gray-800 min-w-[300px] flex justify-between items-center flex-col" onMouseEnter={handleShadow3} onMouseLeave={handleNoShadow3}
                style={{
                  boxShadow:
                  `${shadow3}`,
                }}
          ...
          <div className="cards h-[420px]  p-10">
            <Link to="/mycomplaints">
              <div
                className=" max-w-sm rounded-[40px] overflow-hidden shadow-lg h-[100%] bg-white text-gray-800 min-w-[300px] flex justify-between items-center flex-col" onMouseEnter={handleShadow4} onMouseLeave={handleNoShadow4}
                style={{
                  boxShadow:
                  `${shadow4}`,
                }}
